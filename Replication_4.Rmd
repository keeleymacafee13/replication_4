...
```{r distpred, echo=FALSE, message=FALSE, warning=FALSE}
...
# Regression of 2004 vote on distance of demolition, data created during the matching of white and black residents, and 2000 vote. 
out.reg = zelig(vote2004 ~ log(demo.distance) + log(context_black) + nvote2000, data = usedata, model = 'ls', cite = F)

# Begin simulations across variable values. While running the code, this seemed important for storing values in dataframes. 
